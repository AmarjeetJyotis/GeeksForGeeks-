...
class Solution {
  public:
    ...
    Node* helper(Node* root, Node* &prev, Node* parent, string direction){
        if(root==NULL) return NULL;
        Node* left=helper(root->left,prev,root,"L");
        Node* right=helper(root->right,prev,root,"R");
